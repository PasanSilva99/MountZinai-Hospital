                            ...
                            <div style="display: block;height: 100%;">
                                <div class="row">
                                    <div class="col WidgetTotal hoverWhite">
                                        <div></div><span class="text-white WidgetTitleSmall" style="font-size: 19px;">Registered Patients<span class="text-white WidgetTitleSmall" style="font-size: 36px;">521</span></span>
                                    </div>
                                    ...
                                    <div class="col WidgetTotal hoverWhite">
                                        <div></div><span class="WidgetTitleSmall" style="color: rgb(255,255,255);font-size: 19px;">Admitted Patients<span class="WidgetTitleSmall" style="font-size: 36px;">12</span></span>
                                    </div>
                                </div>
                                                        ...
                                                        <tr>
                                                            <td class="listItem">
                                                                <div class="d-flex flex-row listItemBg" style="width: 100%;">
                                                                    ...
                                                                    <div class="d-flex d-xl-flex flex-row align-items-xl-center" style="height: 100%;border-color: var(--blue);width: 30%;">
