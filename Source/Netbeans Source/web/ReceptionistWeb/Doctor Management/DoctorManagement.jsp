        ...
        <div class="fillPage">
            <div id="sideNav">
                ...
                <div class="navItem">
                    ...
                    </div><img class="NavItemImage" style="width: 35px;height: 35px;margin-left: 29%;margin-right: auto;position: relative;margin-top: 12%;" src="../assets/img/doctor.svg"><span class="NavItemText" style="width: 100%;text-align: center;display: block;position: relative;">Doctor<br>Management</span>
                </div>
                <div class="navItem">
                    <div style="position: absolute;width: 100%;height: 100%;">
                        <div class="NavItemBg-nonActive" style="position: absolute;width: 100%;height: 100%;"></div>
                ...
                <div class="container-fluid d-inline-flex container-size">
                    <div class="col">
                        ...
                        <div class="mid-column-doc">
                            ...
                            <div class="find-doctor" style="background: linear-gradient(51deg, rgb(47,177,255) 0%, #2FB1FF 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Find A -->
                                <div class="find-text-lbl"><span style="font-size: 57px;color: rgb(255,255,255);text-align: left;">FIND A&nbsp;</span></div><!-- End: Find A -->
                                <!-- Start: Doctor -->
                                <div class="doctor-text-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">DOCTOR</span></div><!-- End: Doctor -->
                                <!-- Start: Search Section -->
                                <div class="search-field-doc"><input class="form-control-lg search-field-length" type="search" placeholder="        Doctor Name" style="width: 301.4px;background: #43a7df;color: rgb(255,255,255);opacity: 1;"></div><!-- End: Search Section -->
                                <!-- Start: Patient Icon -->
                                <div><img class="user-name-new" src="../assets/img/doctor.svg" style="filter: invert(100%);"></div><!-- End: Patient Icon -->
                                <!-- Start: Search Icon -->
                                <div><img class="search-icon" src="../assets/img/search.svg" style="filter: invert(100%);opacity: 0.72;"></div><!-- End: Search Icon -->
                            </div><!-- End: Find A Doctor Section -->
                        </div><!-- End: Find A Doctor -->
                        <div class="bottom-card">
                            <!-- Start: Session Directory -->
                            <div class="session-directory" style="background: linear-gradient(24deg, rgb(47,148,252) 23%, rgb(142,223,249) 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Session -->
                                <div class="session-text"><span style="font-size: 57px;color: rgb(255,255,255);text-align: left;">SESSION</span></div><!-- End: Session -->
                                <!-- Start: Directory -->
                                <div class="directory-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">DIRECTORY</span></div><!-- End: Directory -->
                                <!-- Start: Session Directoty Icon -->
                                <div><img class="session-directory-icon" src="../assets/img/patient.svg" style="filter: invert(100%);"></div><!-- End: Session Directoty Icon -->
                            </div><!-- End: Session Directory -->
                            <!-- Start: All Doctors -->
                            <div class="all-doctors" style="background: linear-gradient(24deg, rgb(47,148,252) 23%, rgb(142,223,249) 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: All -->
                                <div class="all-text-doc"><span style="font-size: 57px;color: rgb(255,255,255);text-align: left;">ALL</span></div><!-- End: All -->
                                <!-- Start: Doctors -->
                                <div class="doctors-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">DOCTORS</span></div><!-- End: Doctors -->
                                <!-- Start: All Doctors Icon -->
                                <div><img class="all-doctos-icon" src="../assets/img/doctor%20group.svg" style="filter: invert(100%);"></div><!-- End: All Doctors Icon -->
                            </div><!-- End: All Doctors -->
                        </div>
                    </div>
                    <div class="col-xl-5">
                        <div class="WidgetGray" style="height: 95%;position: absolute;width: 95%;bottom: 0;top: 0;left: 0;right: 0;margin: 5px;"><span class="text-left WidgetTitleSmall" style="margin-left: 25px;font-size: 21px;">Available Doctors</span><!-- Start: List Description Names -->
                            <div class="descriptive-lbl">
                                <!-- Start: Name Label -->
                                <div class="name-lbl-doc"><label>Name</label></div><!-- End: Name Label -->
                                <!-- Start: Status -->
                                <div class="doc-status"><label>Status</label></div><!-- End: Status -->
                                <!-- Start: Room No. -->
                                <div class="doc-num"><label>Room No.</label></div><!-- End: Room No. -->
                                                ...
                                                <td class="listItem">
                                                    <div class="d-flex flex-row listItemBg" style="width: 100%;">
                                                        ...
                                                        <div class="toggle-status">
                                                            <!-- Start: Toggle Switch --><label class="switch">
  <input type="checkbox">
  <span class="slider round"></span>
</label><!-- End: Toggle Switch -->
                                                        </div>
                                                        <div class="d-xl-flex justify-content-xl-end align-items-xl-center" style="height: 100%;margin-right: 15px;width: 100%;text-align: right;">
                                                            <!-- Start: select dropdown --><select class="Room-Allocate" style="padding-left: 5px;border: 1px solid rgb(176,176,176);background: rgb(247,251,255);height: 28px;" required="">
                                                                <option value="1" style="border-radius: 10px;">1</option>
