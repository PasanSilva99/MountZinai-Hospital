            ...
            <div id="page">
                <div class="row">
                        ...
                        <div class="common-div-doc">
                            ...
                            <div class="btn-set-doc">
                                ...
                                <div class="low-btn-set">
                                    ...
                                    <!-- Start: Save btn --><button class="btn btn-primary save-btn-doc" type="button" style="font-size: 22px;text-align: right;">Add<img class="search-icon-doc" src="../assets/img/add.svg" style="filter: invert(100%);"></button><!-- End: Save btn -->
                                </div><!-- End: Button Set -->
                    ...
                    <div class="col">
                        ...
                        <div class="doc-channel"><label style="font-size: 31px;color: var(--blue);">SESSION&nbsp;<span style="color: rgb(0,0,0);">DIRECTORY</span></label><img class="doc-channel-img" src="../assets/img/stethoscope.svg"></div><!-- End: Doctor Channel Section -->
                    </div>
                </div>
            </div>
        </div>
