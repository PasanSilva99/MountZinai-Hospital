   ...
   <!-- Start Top Navigation -->
    ...
    <section class="pagecont">
        <div class="fillPage">
            ...
            <div id="page">
                <div class="row">
                    <div class="col WidgetGray" style="display: block;height: 488px;width: 100%;"><span class="text-left WidgetTitleSmall" style="font-size: 24px;">Session List</span><!-- Start: Table Headings -->
                        <div class="table-headings">
                            <!-- Start: Patient Name Wrap -->
                            <div class="patient-name"><span class="text-left WidgetTitleSmall" style="font-size: 19px;">Doctor ID</span></div><!-- End: Patient Name Wrap -->
                                        ...
                                        <tr>
                                            ...
                                            <td class="listItem">
                                                <div class="d-flex flex-row listItemBg" style="width: 100%;height: 6vh;">
                                                    <div class="d-xl-flex align-items-xl-center" style="width: 35px;height: 100%;padding: 5px;"><img class="img-fluid icon-position" src="../assets/img/appointment%20-%20patient.svg"></div><!-- Start: D-id -->
                                                    <div class="p-name-lbl"><span style="font-size: 14px;">1021543</span></div><!-- End: D-id -->
                                                    <!-- Start: d-name-lbl -->
                        ...
                        <div class="row">
                            <div class="col offset-10">
                                ...
                                <div class="btn-contain">
                                    <!-- Start: Back btn -->
                                    <div class="session-back-btn"><button class="btn btn-primary back-btn-session" type="button">Back</button></div><!-- End: Back btn -->
                                    <!-- Start: Schedule a Session btn -->
                                    <div><button class="btn btn-primary schedule-btn" type="button">Schedule a Session</button></div><!-- End: Schedule a Session btn -->
                                </div><!-- End: Button contain -->
                            </div>
                        </div>
                    </div>
                </div>
