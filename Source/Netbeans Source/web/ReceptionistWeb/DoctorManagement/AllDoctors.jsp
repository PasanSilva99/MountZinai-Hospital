        ...
        <div id="page">
          ...
          <div class="container" style="display: block; height: 100%">
            ...
            <div class="all-patient-lbl">
              <!-- Start: Image Icon -->
              <div>
                <img class="image-patient" src="../assets/img/doctor.svg" />
              </div>
              <!-- End: Image Icon -->
              <!-- Start: All Label -->
              ...
              <!-- End: All Label -->
              <!-- Start: Patients -->
              <div class="doctor-text-all">
                <label style="font-size: 32px">DOCTORS</label>
              </div>
              <!-- End: Patients -->
              <a href="DoctorManagement.jsp" style="text-decoration:none;">
              <!-- Start: My Back Btn -->
              <button
                class="btn btn-primary back-btn-all-doctor"
                type="button"
            ...
            >
              ...
              >
                ...
                <div class="col listHeader">
                  <span class="listHeader">Contact No</span>
                </div>
                <div class="col listHeader">
              ...
              >
                ...
                <div class="col listHeader">
                  <span class="listHeader">Cardiology</span>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div class="col listHeader">
                  <span class="listHeader">Neurology</span>
                </div>
              </div>
              <div
                class="d-xl-flex align-items-xl-center row FullListItem"
