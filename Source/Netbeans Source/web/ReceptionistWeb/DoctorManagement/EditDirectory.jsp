                        ...
                        <div class="common-div-doc">
                            ...
                            <div class="input-set-doc">
                                ...
                                <div class="appointment-no-section">
                                    <!-- Start: Doc Name -->
                                    <div><label>Doctor ID</label></div><!-- End: Doc Name -->
                                    <!-- Start: Doc Name Div -->
                                    <div class="doc-name-div">
                                        <!-- Start: Appoint No. Icon -->
                                        <div class="doc-name-icon"><img src="../assets/img/doctor.svg" style="width: 2rem;"></div><!-- End: Appoint No. Icon --><input class="form-control-lg doc-name-input" type="text" placeholder="1020456">
                                    </div><!-- End: Doc Name Div -->
                                </div><!-- End: Doctor Name -->
                                <!-- Start: Session Date -->
                                <div class="patient-name-section">
                                    <!-- Start: Specialization lbl -->
                                    <div><label>Pick a Session Date</label></div><!-- End: Specialization lbl -->
                                    <!-- Start: Specialization Div -->
                                    <div class="appointment-no-div">
                                        <!-- Start: Specialization Icon -->
                                        <div class="appointment-no-icon"><input class="form-control-lg session-date-doc" type="date"></div><!-- End: Specialization Icon -->
                                    </div><!-- End: Specialization Div -->
                                </div><!-- End: Session Date -->
                                <!-- Start: Pick A Date -->
                                <div class="doctor-name-section">
                                    <!-- Start: Pick A Date lbl -->
                                    <div><label>Session Time</label></div><!-- End: Pick A Date lbl -->
                                    <!-- Start: Pick A Date Div -->
                                    <div class="appointment-no-div">
                                        <!-- Start: Pick A Date Icon -->
                                        <div class="appointment-no-icon"><input class="form-control-lg session-time-doc" type="time"></div><!-- End: Pick A Date Icon -->
                                    </div><!-- End: Pick A Date Div -->
                                </div><!-- End: Pick A Date -->
                            </div><!-- End: Input Set Doc -->
                            ...
                            <div class="btn-set-doc">
                                ...
                                <div class="low-btn-set">
                                    ...
                                    <!-- Start: Save btn --><button class="btn btn-primary save-btn-edit" type="button" style="font-size: 22px;text-align: right;">Save<img class="delete-icon" src="../assets/img/floppy-disk.svg" style="filter: invert(100%);"></button><!-- End: Save btn -->
                                </div><!-- End: Button Set -->
                            </div><!-- End: RightColumn Set -->
                        </div><!-- Start: Session Directory -->
                        <div class="session-directory-smaill-card" style="background: linear-gradient(24deg, rgb(47,148,252) 23%, rgb(142,223,249) 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                            <!-- Start: View -->
                            <div class="view-txt"><span style="font-size: 44px;color: rgb(255,255,255);text-align: left;">VIEW</span></div><!-- End: View -->
                            <!-- Start: Sessions -->
                            <div class="session-text"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 21px;">SESSIONS</span></div><!-- End: Sessions -->
                            <!-- Start: View Session Icon -->
                            <div><img class="view-session-icon" src="../assets/img/stethoscope.svg" style="filter: invert(100%);"></div><!-- End: View Session Icon -->
                        </div><!-- End: Session Directory -->
                    </div>
                    <div class="col">
                        <!-- Start: Doctor Channel Section -->
                        <div class="doc-channel"><label style="font-size: 31px;color: var(--blue);">EDIT&nbsp;<span style="color: rgb(0,0,0);">DIRECTORY</span></label><img class="doc-channel-img" src="../assets/img/stethoscope.svg"></div><!-- End: Doctor Channel Section -->
                    </div>
                </div>
            </div>
        </div>
