...
<body>
   <!-- Start Top Navigation -->
    ...
    <section class="pagecont">
        ...
        </div><!-- Start: Confirm btn --><button class="btn btn-primary book-btn-patient-arrange" type="button" style="font-size: 22px;text-align: right;">Arrange a Session<img class="arrange-icon" src="../assets/img/stethoscope.svg" style="filter: invert(100%);"></button><!-- End: Confirm btn -->
