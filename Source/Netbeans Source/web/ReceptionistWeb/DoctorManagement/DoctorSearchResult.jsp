...
<html lang="en">
  ...
  <body>
    ...
    <section class="pagecont">
          ...
          <div class="row">
            <div class="col">
              ...
              <div class="all-patient-lbl">
                <!-- Start: Image Icon -->
                <div>
                  <img class="image-patient" src="../assets/img/search.svg" />
                </div>
                <!-- End: Image Icon -->
                <!-- Start: All Label -->
                ...
                <!-- End: All Label -->
                <!-- Start: Patients -->
                <div class="patient-text-lbl-list">
              ...
              <div>
                <!-- Start: Patient Card -->
                <div
                  class="common-div-patient-search"
                  style="
                    background: linear-gradient(66deg, #2fb1ff 0%, #3bccf9),
                      #2fb1ff;
                  "
                >
                  <!-- Start: Doc Image -->
                  <div>
                    <img
                      class="doc-img"
                      src="../assets/img/patient-colour.svg"
                    />
                  </div>
                  <!-- End: Doc Image -->
                  ...
                  <div class="patient-details">
                    <!-- Start: Doc Name -->
                    <div>
                      <!-- Start: Name Label --><label
                        style="font-size: 24px; color: rgb(255, 255, 255)"
                        >MS. DINESHA DISSANAYAKE</label
                      ><!-- End: Name Label -->
                    </div>
                    <!-- End: Doc Name -->
                    ...
                    <div class="specialization-wrap">
                      <!-- Start: Time --><label
                        style="font-size: 22px; color: rgb(255, 255, 255)"
                        >5412879</label
                      ><!-- End: Time -->
                    </div>
                    <!-- End: Specialization Wrap -->
                    <!-- Start: Age Wrap -->
                    <div class="specialization-wrap">
                      <!-- Start: Time --><label
                        style="font-size: 22px; color: rgb(255, 255, 255)"
      ...
      <!-- Start: Confirm btn --><button
        class="btn btn-primary book-btn-patient-arrange"
        type="button"
        style="font-size: 22px; text-align: right"
      >
        Arrange a Session<img
          class="arrange-icon"
    ...
    <div class="search-patient">
      <!-- Start: Search Icon -->
      <div>
        <img class="patient-icon-search" src="../assets/img/patient-new.svg" />
      </div>
      <!-- End: Search Icon -->
      ...
      <!-- Start: Patient Icon -->
      <div><img class="icon-search" src="../assets/img/search.svg" /></div>
      <!-- End: Patient Icon -->
    </div>
    <!-- End: Search Patient -->
