                    ...
                    <div class="col">
                        ...
                        <div class="mid-column-doc">
                            ...
                            <div class="find-doctor" style="background: linear-gradient(51deg, rgb(47,177,255) 0%, #2FB1FF 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Find A -->
                                <div class="find-text-lbl"><span style="font-size: 57px;color: rgb(255,255,255);text-align: left;">FIND A PATIENT</span></div><!-- End: Find A -->
                                <!-- Start: Doctor -->
                                <div class="doctor-text-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">REPORT</span></div><!-- End: Doctor -->
                                <!-- Start: Search Section -->
                                <div class="search-field-doc"><input class="form-control-lg search-field-length" type="search" placeholder="        Patient Name" style="width: 301.4px;background: #43a7df;color: rgb(255,255,255);opacity: 1;"></div><!-- End: Search Section -->
                                <!-- Start: Patient Icon -->
                        ...
                        <div class="bottom-card">
                            ...
                            <div class="all-doctors" style="background: linear-gradient(24deg, rgb(47,148,252) 23%, rgb(142,223,249) 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Add -->
                                <div class="add-text-lbl-mr"><span style="font-size: 72px;color: rgb(255,255,255);text-align: left;">ADD</span></div><!-- End: Add -->
                                <!-- Start: Report -->
                                <div class="report-text-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">Patient</span></div><!-- End: Report -->
                                <!-- Start: All Report Icon -->
                                <div><img class="add-patients-icon" src="../assets/img/add-report.png" style="filter: invert(0%);"></div><!-- End: All Report Icon -->
                            </div><!-- End: All Doctors -->
                        </div>
                    </div>
                    <div class="col-xl-5">
