<%-- 
    ...
    Created on : 12-May-2021, 16:09:35
        ...
        <div class="fillPage">
            ...
            <div id="page">
                <div class="container-fluid d-inline-flex container-size">
                    <div class="col total-patient">
                        <div class="row row1">
                            ...
                            <div class="col" style="background: linear-gradient(-76deg, #2f94fc, rgb(47,177,255) 99%);border-radius: 19px;box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                ...
                                <div class="total-patients-wrap"><span style="font-size: 36px;color: rgb(255,255,255);">Total Patients</span></div><!-- End: Total Patients Wrap -->
                                <!-- Start: Patients Label -->
                                <div class="patients-lbl"><span style="color: rgb(255,255,255);font-size: 88px;">75</span></div><!-- End: Patients Label -->
                            </div><!-- End: Total Patients Card -->
                        </div>
                    </div>
                    <div class="col">
                        <div class="mid-column">
                            ...
                            <div class="all-patient" style="background: linear-gradient(24deg, rgb(47,148,252) 23%, rgb(142,223,249) 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: All -->
                                <div class="all-text-lbl" style="left: 2vw;top: 1vh;"><span style="font-size: 57px;color: rgb(255,255,255);text-align: left;">ALL</span></div><!-- End: All -->
                                <!-- Start: Patients -->
                            ...
                            <div class="add-patient" style="background: linear-gradient(118deg, rgb(47,148,252) 0%, rgb(142,223,249) 121%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Add -->
                                <div class="add-text-lbl"><span style="font-size: 57px;color: rgb(255,255,255);text-align: left;">ADD</span></div><!-- End: Add -->
                                <!-- Start: Patient -->
                            ...
                            <div class="find-patient" style="background: linear-gradient(51deg, rgb(47,177,255) 0%, #2FB1FF 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Find A -->
                                <div class="add-text-lbl"><span style="font-size: 57px;color: rgb(255,255,255);text-align: left;">FIND A</span></div><!-- End: Find A -->
                                <!-- Start: Patient -->
                                <div class="patients-text-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">Patient</span></div><!-- End: Patient -->
                    ...
                    <div class="col-xl-5">
                        <div class="WidgetGray" style="height: 95%;position: absolute;width: 95%;bottom: 0;top: 0;left: 0;right: 0;margin: 5px;"><span class="text-left WidgetTitleSmall" style="margin-left: 25px;font-size: 21px;">Recently Registered Patients</span><!-- Start: List Description Names -->
