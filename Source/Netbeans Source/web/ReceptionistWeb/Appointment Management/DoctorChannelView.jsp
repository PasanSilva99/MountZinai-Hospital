<%-- 
    Document   : DoctorChannelView
    Created on : 12-May-2021, 15:48:05
            ...
            <div id="page">
                <div class="row">
                        ...
                        <div class="common-div-doc">
                            ...
                            <div class="input-set-doc">
                                ...
                                <div class="appointment-no-section">
                                    <!-- Start: Doc Name -->
                                    <div><label>Doctor Name</label></div><!-- End: Doc Name -->
                                    <!-- Start: Doc Name Div -->
                                    <div class="doc-name-div">
                                        <!-- Start: Appoint No. Icon -->
                                        <div class="doc-name-icon"><img src="../assets/img/doctor.svg" style="width: 2rem;"></div><!-- End: Appoint No. Icon --><input class="form-control-lg doc-name-input" type="text" placeholder="Dr.Anura Perera">
                                    </div><!-- End: Doc Name Div -->
                                </div><!-- End: Doctor Name -->
                                <!-- Start: Specialization -->
                                <div class="patient-name-section">
                                    <!-- Start: Specialization lbl -->
                                    <div><label>Specialization</label></div><!-- End: Specialization lbl -->
                                    <!-- Start: Specialization Div -->
                                    <div class="appointment-no-div">
                                        <!-- Start: Specialization Icon -->
                                        <div class="appointment-no-icon"><img src="../assets/img/first-aid-kit.svg" style="width: 2rem;"></div><!-- End: Specialization Icon --><input class="form-control-lg appointmen-no-input" type="text" placeholder="Cardiology">
                                    </div><!-- End: Specialization Div -->
                                </div><!-- End: Specialization -->
                                <!-- Start: Pick A Date -->
                                <div class="doctor-name-section">
                                    <!-- Start: Pick A Date lbl -->
                                    <div><label>Pick A Date</label></div><!-- End: Pick A Date lbl -->
                                    <!-- Start: Pick A Date Div -->
                                    <div class="appointment-no-div">
                                        <!-- Start: Pick A Date Icon -->
                                        <div class="appointment-no-icon"><input class="form-control-lg session-date-doc" type="date"></div><!-- End: Pick A Date Icon -->
                            ...
                            <div class="btn-set-doc">
                                ...
                                <div class="low-btn-set">
                                    ...
                                    <!-- Start: Save btn --><button class="btn btn-primary save-btn-doc" type="button" style="font-size: 22px;text-align: right;">Search<img class="search-icon-doc" src="../assets/img/search.svg" style="filter: invert(100%);"></button><!-- End: Save btn -->
                                </div><!-- End: Button Set -->
                    ...
                    <div class="col">
                        ...
                        <div class="doc-channel"><label style="font-size: 31px;color: var(--blue);">DOCTOR&nbsp;<span style="color: rgb(0,0,0);">CHANNEL</span></label><img class="doc-channel-img" src="../assets/img/stethoscope.svg"></div><!-- End: Doctor Channel Section -->
                    </div>
                </div>
            </div>
        </div>
