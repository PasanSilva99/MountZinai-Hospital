        ...
        <div class="fillPage">
            ...
            <div id="page">
                <div class="row">
                    <div class="col">
                        <!-- Start: Channel Card -->
                        <div class="common-div-doc-book-view">
                            <!-- Start: Date And Time -->
                            ...
                            <div class="available-time">
                                <!-- Start: Date Wrap Div -->
                                <div>
                                    <!-- Start: Date --><label style="font-size: 20px;">AVAILABLE TIME</label><!-- End: Date -->
                                </div><!-- End: Date Wrap Div -->
                                <!-- Start: Time Wrap -->
                                <div class="available-wrap-div">
                                    <!-- Start: Time --><label style="font-size: 28px;">10.30-11.00</label><!-- End: Time -->
                                </div><!-- End: Time Wrap -->
                            </div><!-- End: Available Time -->
                        </div><!-- End: Channel Card -->
                        <!-- Start: NIC Confirm -->
                        <div class="nic-confirm">
                            <!-- Start: Patient Icon -->
                            <div><img class="patient-icon" src="../assets/img/patient.svg"></div><!-- End: Patient Icon -->
                            <!-- Start: NIC Text Input -->
                            <div><input type="text" class="nic-input" placeholder="Enter Patient`s NIC No." style="font-size: 25px;"></div><!-- End: NIC Text Input -->
                        </div><!-- End: NIC Confirm -->
                        <!-- Start: Btn Section -->
                        <div class="btn-set-doc">
                            <!-- Start: Button Set -->
                            <div class="low-btn-set-doc-search">
                                <!-- Start: Back btn --><button class="btn btn-primary back-btn-doc-book" type="button" style="font-size: 22px;text-align: center;">Back</button><!-- End: Back btn -->
                                <!-- Start: Book btn -->
                                <div>
                                    <!-- Start: Book btn --><button class="btn btn-primary book-btn-doc-book" type="button" style="font-size: 22px;text-align: right;">Confirm<img class="confirm-icon-doc" src="../assets/img/confirmation.svg" style="filter: invert(100%);"></button><!-- End: Book btn -->
                                </div><!-- End: Book btn -->
                            </div><!-- End: Button Set -->
                        </div><!-- End: Btn Section -->
                    </div>
