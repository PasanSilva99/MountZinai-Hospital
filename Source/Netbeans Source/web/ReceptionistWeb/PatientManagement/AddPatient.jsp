            ...
            <div id="page">
                ...
                <div class="container" style="display: block;height: 100%;">
                    ...
                    <div class="all-patient-lbl">
                        ...
                        <!-- Start: All Label -->
                        <div class="all-text-lbl"><label style="font-size: 48px;color: var(--blue);">ADD</label></div><!-- End: All Label -->
                        <!-- Start: Patients -->
                        <div class="patient-text-lbl-list" style="left: -7vw;"><label style="font-size: 32px;">PATIENT</label></div><!-- End: Patients -->
