            ...
            <div id="page">
                <div class="container-fluid d-inline-flex container-size">
                    <div class="col total-patient">
                        <!-- Start: Admitted Patient Card -->
                        <div class="row admit-patients-row">
                            <!-- Start: Total Admitted Patients Card -->
                            <div class="col" style="background: linear-gradient(-76deg, #2f94fc, rgb(47,177,255) 99%);border-radius: 19px;box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Admitted Patients Wrap -->
                                <div class="admitted-patients-wrap"><span class="admitted-patients-lbl" style="/*color: rgb(255,255,255);*/">Admitted Patients</span></div><!-- End: Admitted Patients Wrap -->
                                <!-- Start: Patients Label -->
                                <div class="admit-patients-lbl"><span class="admit-lbl">75</span></div><!-- End: Patients Label -->
                            </div><!-- End: Total Admitted Patients Card -->
                        </div><!-- End: Admitted Patient Card -->
                        <!-- Start: Discharge Patent -->
                        <div class="row discharge-patients-row">
                            <!-- Start: Discharge Patient -->
                            <div class="col" style="background: linear-gradient(-76deg, #2f94fc, rgb(47,177,255) 99%);border-radius: 19px;box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Discharge -->
                                <div class="discharge-text-lbl"><span class="discharge-text">DISCHARGE</span></div><!-- End: Discharge -->
                                <!-- Start: Patient -->
                                <div class="patient-text-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">Patient</span></div><!-- End: Patient -->
                                <!-- Start: discahrge patient icon -->
                                <div class="discharge-patient-icon"><img class="discharge-icon" src="../assets/img/discharge%20patient.svg" style="filter: invert(100%);opacity: 0.80;"></div><!-- End: discahrge patient icon -->
                            </div><!-- End: Discharge Patient -->
                        </div><!-- End: Discharge Patent -->
                    </div>
                    <div class="col">
                        <div class="mid-column">
                            <!-- Start: All Patients Card -->
                            <div class="all-patient" style="background: linear-gradient(24deg, rgb(47,148,252) 23%, rgb(142,223,249) 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: All -->
                                <div class="all-text-lbl" style="position: relative;left: 2vw;top: 2vh;"><span style="font-size: 57px;color: rgb(255,255,255);text-align: left;">ALL</span></div><!-- End: All -->
                                <!-- Start: Patients -->
                                <div class="patients-text-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">Patients</span></div><!-- End: Patients -->
                                <!-- Start: All Patients Icon -->
                                <div><img class="all-patients-icon" src="../assets/img/patient.svg" style="filter: invert(100%);"></div><!-- End: All Patients Icon -->
                            </div><!-- End: All Patients Card -->
                            <!-- Start: Add Patient Card -->
                            <div class="add-patient" style="background: linear-gradient(118deg, rgb(47,148,252) 0%, rgb(142,223,249) 121%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Admit -->
                                <div class="admit-text-lbl"><span class="admit-text">ADMIT</span></div><!-- End: Admit -->
                                <!-- Start: Patient -->
                                <div class="admit-patient-text-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">Patient</span></div><!-- End: Patient -->
                                <!-- Start: All Patients Icon -->
                                <div><img class="all-patients-icon" src="../assets/img/add-patient.svg" style="filter: invert(100%);"></div><!-- End: All Patients Icon -->
                            </div><!-- End: Add Patient Card -->
                            <!-- Start: Find A Patient Section -->
                            <div class="find-patient" style="background: linear-gradient(51deg, rgb(47,177,255) 0%, #2FB1FF 100%);box-shadow: 3px 1px 6px rgb(124,129,135), 3px 1px 6px rgb(124,129,135);">
                                <!-- Start: Find A -->
                                <div class="add-text-lbl"><span style="font-size: 57px;color: rgb(255,255,255);text-align: left;">FIND ADMITTED</span></div><!-- End: Find A -->
                                <!-- Start: Patient -->
                                <div class="patients-text-lbl"><span class="text-uppercase" style="color: rgb(255,255,255);font-size: 30px;">Patient</span></div><!-- End: Patient -->
                                <!-- Start: Search Section -->
                                <div class="search-field"><input class="form-control-lg search-field-length" type="search" placeholder="        Patient Name" style="width: 301.4px;background: #43a7df;color: rgb(255,255,255);opacity: 1;"></div><!-- End: Search Section -->
                                <!-- Start: Patient Icon -->
                                <div><img class="user-name-new" src="../assets/img/patient-new.svg" style="filter: invert(100%);"></div><!-- End: Patient Icon -->
                                <!-- Start: Search Icon -->
                                <div><img class="search-icon" src="../assets/img/search.svg" style="filter: invert(100%);opacity: 0.72;"></div><!-- End: Search Icon -->
                            </div><!-- End: Find A Patient Section -->
                        </div>
                    </div>
                    <div class="col-xl-5">
                        <div class="WidgetGray" style="height: 95%;position: absolute;width: 95%;bottom: 0;top: 0;left: 0;right: 0;margin: 5px;"><span class="text-left WidgetTitleSmall" style="margin-left: 25px;font-size: 21px;">Recently Admitted Patients</span><!-- Start: List Description Names -->
                            <div class="descriptive-lbl">
                                <!-- Start: Name Label -->
                                <div class="name-lbl"><label>Name</label></div><!-- End: Name Label -->
                                <!-- Start: NIC Label -->
                                <div class="nic-lbl"><label>NIC</label></div><!-- End: NIC Label -->
                                            ...
                                            <tr>
                                                ...
                                                <td class="listItem">
                                                    <div class="d-flex flex-row listItemBg" style="width: 100%;">
                                                        <div class="d-xl-flex align-items-xl-center" style="width: 45px;height: 100%;padding: 5px;"><img class="img-fluid" src="../assets/img/profile.svg"></div>
                                                        ...
                                                        <div class="d-xl-flex justify-content-xl-end align-items-xl-center" style="height: 100%;margin-right: 15px;width: 100%;text-align: right;"><span style="font-size: 12px;margin-left: 7px;">973102729V</span></div>
                                                    </div>
                                                </td><!-- End: 1st row -->
                                                <!-- Start: 1st row -->
                                                <td class="listItem">
