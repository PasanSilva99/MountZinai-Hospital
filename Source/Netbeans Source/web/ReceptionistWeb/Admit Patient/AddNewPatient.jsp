            ...
            <div id="page">
                ...
                <div class="container" style="display: block;height: 100%;">
                    ...
                    <div class="all-patient-lbl">
                        ...
                        <!-- Start: All Label -->
                        <div class="all-text-lbl"><label style="font-size: 48px;color: var(--blue);">ADMIT</label></div><!-- End: All Label -->
                        <!-- Start: Patients -->
                        <div class="admit-patient"><label style="font-size: 32px;">PATIENT</label></div><!-- End: Patients -->
