            ...
            <div id="page">
                ...
                <div class="container" style="display: block;height: 100%;">
                    ...
                    <div class="all-patient-lbl">
                        <!-- Start: Image Icon -->
                        <div><img class="image-patient" src="../assets/img/discharge%20patient.svg"></div><!-- End: Image Icon -->
                        <!-- Start: Discharge txt -->
                        <div class="discharge-lbl"><label style="font-size: 48px;color: var(--blue);">DISCHARGE</label></div><!-- End: Discharge txt -->
                        <!-- Start: Patients -->
                        <div class="discharge-patient"><label style="font-size: 32px;">PATIENT</label></div><!-- End: Patients -->
                        <!-- Start: My Back Btn --><button class="btn btn-primary back-btn-discharge-patient" type="button" style="font-size: 22px;text-align: center;">Back</button><!-- End: My Back Btn -->
                        <div>
                            <!-- Start: Discharge txt -->
                            <div class="search-a-patient-lbl" style="font-size: 9px;"><label style="font-size: 21px;color: var(--blue);">SEARCH A PATIENT TO</label></div><!-- End: Discharge txt -->
                            <!-- Start: Seach Patient lbl -->
                            <div class="search-discharge"><label style="font-size: 21px;">DISCHARGE</label></div><!-- End: Seach Patient lbl -->
                        </div>
                    ...
                    <div class="WidgetGray recently-discharge-patient"><span class="text-left WidgetTitleSmall" style="margin-left: 25px;font-size: 21px;">Recently Discharge Patients</span><!-- Start: List Description Names -->
                        <div class="descriptive-lbl">
                            <!-- Start: Name Label -->
                            <div class="name-lbl"><label>Name</label></div><!-- End: Name Label -->
                            <!-- Start: NIC Label -->
                            <div class="discharge-detail-lbl"><label>Discharge Date</label></div><!-- End: NIC Label -->
                                        ...
                                        <tr>
                                            ...
                                            <td class="listItem">
                                                <div class="d-flex flex-row listItemBg" style="width: 100%;">
                                                    ...
                                                    <div class="d-xl-flex justify-content-xl-end align-items-xl-center" style="height: 100%;margin-right: 15px;width: 100%;text-align: right;"><span style="font-size: 12px;margin-left: 7px;">01/02/2021</span></div>
                                                </div>
                                            </td><!-- End: 1st row -->
                                            <!-- Start: 1st row -->
                                            <td class="listItem">
                                                <div class="d-flex flex-row listItemBg" style="width: 100%;">
                                                    <div class="d-xl-flex align-items-xl-center" style="width: 45px;height: 100%;padding: 5px;"><img class="img-fluid" src="../assets/img/profile.svg"></div>
                                                    <div class="d-xl-flex align-items-xl-center" style="height: 100%;width: 45%;"><span style="font-size: 12px;margin-left: 6px;">C. H. P. A. Silva</span></div>
                                                    <div class="d-xl-flex justify-content-xl-end align-items-xl-center" style="height: 100%;margin-right: 15px;width: 100%;text-align: right;"><span style="font-size: 12px;margin-left: 7px;">02/04/2021</span></div>
                                                </div>
                                            </td><!-- End: 1st row -->
                                            <!-- Start: 1st row -->
                                            <td class="listItem">
                        ...
                        <div class="d-xl-flex justify-content-xl-center align-items-xl-center showAll-position"><span>Show All</span></div>
                    </div>
