        ...
        <div id="page">
          ...
          <div class="container" style="display: block; height: 100%">
            ...
            <div class="all-patient-lbl">
              ...
              <div class="admited-patients-lbl">
                <label style="font-size: 32px">ADMITTED PATIENTS</label>
              </div>
              <!-- End: Admitted Patients -->
              <!-- Start: My Back Btn -->
              
              <a href="AdmitPatient.jsp">
              <button
                class="btn btn-primary back-btn-all-admitted-patients"
                type="button"
            ...
            <!-- End: All Admitted Patients -->
            <!-- Start: PrimaryButton --><button
              class="btn btn-primary d-xl-flex align-items-xl-center btn-done"
              type="button"
            ...
            >
              ...
              >
                ...
                <div class="col-3 listHeader">
                  <span class="listHeader">Room No.</span>
                </div>
                <div class="col listHeader">
                  <span class="listHeader">Bed No.</span>
                </div>
                <div class="col listHeader">
                  <span class="listHeader">Admit Date</span>
                </div>
              </div>
              <!-- Start: 1st row -->
              <div
              ...
              >
                ...
                <div class="col-3 listHeader">
                  <span class="listHeader">25</span>
                </div>
                <div class="col listHeader">
                  <span class="listHeader">05</span>
                </div>
                <div class="col listHeader">
                  <span class="listHeader">01/04/2021</span>
                </div>
              </div>
              <!-- End: 1st row -->
              <!-- Start: 2nd row -->
              ...
              >
                ...
                <div class="col-3 listHeader">
                  <span class="listHeader">32</span>
                </div>
                <div class="col listHeader">
                  <span class="listHeader">08</span>
                </div>
                <div class="col listHeader">
                  <span class="listHeader">05/04/2021</span>
                </div>
              </div>
              <!-- End: 2nd row -->
              <!-- Start: 2nd row -->
