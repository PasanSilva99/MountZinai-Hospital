<%-- 
    Document   : DischargePatientSearchDetails
    Created on : 13-May-2021, 15:44:27
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="all-patient-lbl">
                            ...
                            <!-- Start: Discharge -->
                            <div class="all-text-lbl"><label style="font-size: 48px;color: var(--blue);">DISCHARGE</label></div><!-- End: Discharge -->
                            <!-- Start: Patients -->
                            <div class="patient-discharge-pos"><label style="font-size: 32px;">PATIENT</label></div><!-- End: Patients -->
                            <!-- Start: My Back Btn --><button class="btn btn-primary back-btn-discharge-patient-info" type="button" style="font-size: 22px;text-align: center;">Back</button><!-- End: My Back Btn -->
