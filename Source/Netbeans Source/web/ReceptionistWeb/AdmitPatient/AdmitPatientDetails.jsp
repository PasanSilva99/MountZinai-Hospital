          ...
          <div class="container" style="display: block; height: 100%">
            ...
            <div class="all-patient-lbl">
              ...
              <div class="patient-text-lbl-list">
                <label style="font-size: 32px">DETAILS</label>
              </div>
              <!-- End: Patients -->
                  ...
                  <div class="col">
                    ...
                    <div class="row">
                      ...
                      >
                        ...
                        ><input class="patient-dob" type="date" />
                      </div>
                      <!-- End: Admit Date -->
                      <div
                        class="
                    ...
                    <div class="row">
                      ...
                      >
                        ...
                        ><!-- Start: select dropdown --><select
                          ...
                          required=""
                        >
                          <option value="AB+" style="border-radius: 10px">
                            AB+
                          </option>
