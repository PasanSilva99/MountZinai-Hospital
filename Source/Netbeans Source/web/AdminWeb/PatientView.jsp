...
<body>
    <section>
        <div id="topNav">
            <div><img alt="" class="img-fluid" id="logo" src="assets/img/MountZinai%20Hospital%20Logo.png"></div><span id="greetingText">Hello C. H. P. A. Silva</span><img alt="" class="img-fluid" id="notificationIcon" src="assets/img/bell.svg"><img alt="" class="img-fluid" id="userImage" src="assets/img/profile.svg">
        </div>
    </section>
