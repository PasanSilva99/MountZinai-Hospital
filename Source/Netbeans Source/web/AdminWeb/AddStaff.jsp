<%-- 
    Document   : AddStaff
    Created on : May 12, 2021, 5:29:40 PM
    Author     : pasan
--%>
                ...
                <div class="container" style="display: block;height: 100%;padding: 5px;">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <!-- Start: ProfileInput -->
                            <div class="row">
                                <div class="d-flex d-xl-flex flex-column justify-content-xl-start align-items-xl-start col"><span>Email</span><input type="text" class="ProfileInput" style="border: 1px solid rgb(176,176,176);background: rgb(247,251,255);" required=""></div>
                            </div><!-- End: ProfileInput -->
                            <!-- Start: ProfileInput -->
                            <div class="row">
                            ...
                            <!-- Start: ProfileInput -->
                            <div class="row">
                                <div class="d-flex d-xl-flex flex-column justify-content-xl-start align-items-xl-start col"><span>Position</span><select class="ProfileInput" style="padding-left: 5px;border: 1px solid rgb(176,176,176);background: rgb(247,251,255);height: 28px;" required="">
                                        <optgroup label="Position" style="border-radius: 10px;">
                            ...
                            <!-- Start: ProfileInput -->
                            <div class="row">
                                <div class="d-flex d-xl-flex flex-column justify-content-xl-start align-items-xl-start col"><span>Confirm Password</span><input type="password" class="ProfileInput" style="padding-left: 5px;border: 1px solid rgb(176,176,176);background: rgb(247,251,255);height: 28px;" required="" placeholder="ConfirmPassword"></div>
                            </div><!-- End: ProfileInput -->
