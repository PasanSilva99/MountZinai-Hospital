<%-- Document : StaffView Created on : May 12, 2021, 8:31:37 AM Author : pasan --%>
...
<% DoctorBean[] Doctors = DocFunc.FetchAllDoctors(); %>
    ...
    <section>
        <div id="topNav">
            ...
            <div class="d-inline-flex float-left justify-content-start card-position">
                <!-- Start: Date Card -->
                <div class="text-center shadow date-card" style="
                     box-shadow: 2px 10px 2px 2px;
                     background: radial-gradient(#3bccf9, #2fb1ff);
                     ">
                    <div class="contain-position">
                        <label id="lbl_day" class="text-uppercase text-center text-white d-block">
                        </label>
                    </div>
                    <div class="date-position">
                        <label id="lbl_date" class="text-center text-white" style="font-size: 33px">
                        </label><sup style="font-size: 19.75px"><label class="text-white" id="lbl_dateSuffix"> </label></sup>
                    </div>
                </div>
                <!-- End: Date Card -->
                <!-- Start: Time Card -->
                <div class="text-center shadow date-card" style="
                    ...
                    <!-- Start: Time Field -->
                    <div class="contain-position">
                        <label class="text-uppercase text-center text-white d-block">Time</label>
                    </div>
                    <!-- End: Time Field -->
                    <!-- Start: Time Content -->
                    <div class="date-position">
                        <label id="lbl_timeHour" class="text-center text-white"
                               style="font-size: 35px; margin-left: 6%"></label>
                        <sub style="font-size: 14.75px"><label id="lbl_timeMinute" class="text-white"></label></sub>
                    </div>
                    <!-- End: Time Content -->
                </div>
                <!-- End: Time Card -->
            </div>
            <img class="img-fluid" id="notificationIcon" src="assets/img/bell.svg" /><img class="img-fluid" id="userImage"
        ...
        <div class="fillPage">
            <div id="sideNav">
                <div class="navItem">
                    ...
                    <img alt="" class="NavItemImage-nonActive" style="
                         width: 35px;
                         height: 35px;
                         margin-left: 28%;
                         margin-right: auto;
                         position: relative;
                         " src="assets/img/dashboard.svg" /><span class="NavItemText-nonActive" style="
                         width: 100%;
                         text-align: center;
                         display: block;
                         position: relative;
                ...
                <div class="navItem">
                    ...
                    <img alt="" class="NavItemImage" style="
                         width: 35px;
                         height: 35px;
                         margin-left: 30%;
                         margin-right: auto;
                         position: relative;
                         margin-top: 12%;
                         " src="assets/img/student-card.svg" /><span class="NavItemText" style="
                         width: 100%;
                         text-align: center;
                         display: block;
                         position: relative;
                ...
                <div class="navItem">
                    ...
                    <img alt="" class="NavItemImage-nonActive" style="
                         ...
                         position: relative;
                         margin-top: 12%;
                         " src="assets/img/stethoscope.svg" /><span class="NavItemText-nonActive" style="
                         width: 100%;
                         text-align: center;
                         display: block;
                         position: relative;
                ...
                <div class="navItem">
                    ...
                    <img alt="" class="NavItemImage-nonActive" style="
                         ...
                         position: relative;
                         margin-top: 12%;
                         " src="assets/img/patient.svg" /><span class="NavItemText-nonActive" style="
                         width: 100%;
                         text-align: center;
                         display: block;
                         position: relative;
            ...
            <div id="page">
                ...
                <div class="container" style="display: block; height: 100%">
                    <span style="color: #3b3b3b">180 Staff Members in total</span><!-- Start: PrimaryButton --><button
                        class="btn btn-primary d-xl-flex align-items-xl-center btn-done" type="button"
                        style="margin-bottom: 10px">
                        <img alt="" class="img-fluid imageInvert" src="assets/img/add.svg"
                             style="width: 20px; height: 20px; margin-right: 5px" />Add New Staff Member</button>
                    <!-- End: PrimaryButton -->
                    <div class="container" style="height: 95%; overflow: scroll">
                        <div class="row" style="
                            ...
                            <div class="col listHeader">
                                <span class="listHeader">Specialization</span>
                            </div>
                            <div class="col-3 listHeader">
                                <span class="listHeader">Email Address</span>
                            </div>
                            <div class="col listHeader">
                                <span class="listHeader">Contact Number</span>
                            </div>
                            <div class="col listHeader">
                                <span class="listHeader">Doctor ID</span>
                            </div>
                        </div>

                        <!-- Load all doctors in to the list -->
                        <%
                    for (int i = 0; i < Doctors.length; i++)
                    {
                        String ListItemHTML = ""
                                + "<div id=\""+ Doctors[i].getDocID() +"\" onClick=\"ListItemClick(this.id);\" class=\"d-xl-flex align-items-xl-center row FullListItem\" style=\""
                                + "border-bottom-width: 2px;"
                                + "border-bottom-color: #a6a6a6;"
                                + "padding-bottom: 10px;"
                                + "padding-top: 10px;"
                                ...
                                + Doctors[i].getSpecialization() + " </span></div> "
                                + " <div class=\"col-3 listHeader\" >  <span class=\"listHeader\" >"
                                + Doctors[i].getEmail()
                                + " </span></div> "
                                + "<div class=\"col listHeader\"><span class=\"listHeader\">"
                                + Doctors[i].getContactNumber()
                                + "</span></div>"
                                + "<div class=\"col listHeader\"><span id=\"txt_"+Doctors[i].getDocID()+"\" class=\"listHeader\">"
                                + Doctors[i].getDocID()
                                + "</span></div></div> ";
