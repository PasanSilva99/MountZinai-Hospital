...
<body>
    <section>
        <div class="d-xl-flex align-items-xl-center" id="topNav">
            <div><img class="img-fluid" id="logo" src="assets/img/MountZinai%20Hospital%20Logo.png" style="margin-top: -7.32px;"></div><span id="greetingText">Hello C. H. P. A. Silva</span><img class="img-fluid" id="notificationIcon" src="assets/img/bell.svg"><img class="img-fluid" id="userImage" src="assets/img/profile.svg" style="height: 35px;width: 35px;border-radius: 35px;">
        </div>
    </section>
