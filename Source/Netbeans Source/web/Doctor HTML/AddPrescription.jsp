<%-- 
    ...
    Created on : May 12, 2021, 4:46:51 PM
    Author     : Sandhara
--%>
...
<body>
    ...
    <section>
        <div id="topNav">
            ...
            </div><img class="img-fluid" id="notificationIcon" src="assets/img/bell.svg"><img class="img-fluid" id="userImage" src="assets/img/patient.svg">
        </div>
        ...
        <div class="fillPage">
            ...
            <div id="page">
                <div class="container w-100 h-100">
                    <div class="row w-100">
                        <div class="d-xl-flex justify-content-xl-center align-items-xl-center col" style="padding-top: 10px;">
                            <div class="d-xl-flex align-items-xl-center" style="padding-top: 10px;"><span style="font-size: 25px;font-family: candara;"><strong>ADD PRESCRIPTION</strong></span><img src="assets/img/prescription%20.svg" style="height: 75px;margin-left: 15px;"></div>
                        </div>
                    </div>
                    <div class="row w-100 h-100" style="padding-top: 35px;display: block;">
                        <div class="d-xl-flex flex-column justify-content-xl-start align-items-xl-center col h-75 w-75" style="background: #D4D9D3;border-radius: 20px;display: block;margin-left: 135px;"><span class="d-xl-flex justify-content-xl-start align-items-xl-start w-100" style="margin-top: 20px;font-size: 18px;">Add Prescription Here</span><textarea class="d-xl-flex h-50 w-100" style="border-radius: 15px;margin-left: 25px;margin-right: 25px;margin-top: 35px;"></textarea>
                            <div class="d-xl-flex flex-row align-items-xl-center" style="float: right;position: absolute;right: 0;bottom: 0;margin-bottom: 35px;margin-right: 30px;"><button class="btn btn-primary text-center d-xl-flex justify-content-xl-center" type="button" style="border-radius: 20px;width: 100px;background-color: #259EFF;">Cancel</button><button class="btn btn-primary" type="button" style="margin-left: 20px;border-radius: 20px;width: 100px;background-color: #099738;">Save</button></div>
                        </div>
                    </div>
                </div>
            </div>
