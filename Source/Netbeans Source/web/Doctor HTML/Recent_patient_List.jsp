<%-- Document : Recent_patient_List Created on : April 10, 2021, 9:19:10 AM
Author : Sandhara --%>
      ...
      <div class="fillPage">
        <div id="sideNav">
          <div class="navItem">
            ...
            /><span
              ...
              >Dashboard</span
            >
            <a herf="DocDashboard.jsp" style="text-decoration: none"> </a>
          </div>
          <div class="navItem">
            <div
        ...
        <div id="page">
          ...
          <div class="container" style="display: block; height: 100%">
            <span style="color: var(--gray)">Recent Patient List</span>
                ...
                ">
                            ...
                            <div class="col listHeader">
                                <span class="listHeader">Appoinment-Time</span>
                            </div>
                            ...
                            <div class="col listHeader">
                                <span class="listHeader">Appoinment-No</span>
                            </div>
                        </div>
                        <div class="
                  d-xl-flex
                ...
                ">
                      ...
                      margin-right: 5px;
                      margin-top: -5px;
                    " src="assets/img/profile.svg" /><span class="listHeader" style="margin-left: 5px">L. G. N. N. Kumarasiri</span
                  >
                </div>
                <div class="col listHeader">
                  <span class="listHeader">10.10am-10.40am</span>
                            </div>
                            <div class="col-3 listHeader">
                            ...
                            <div class="col listHeader">
                                <span class="listHeader">No 29</span>
                            </div>
                        </div>
                        <div class="d-xl-flex align-items-xl-center row FullListItem" style="
                  border-bottom-width: 2px;
                  border-bottom-color: var(--secondary);
                  padding-bottom: 10px;
                  padding-top: 10px;
                ...
                <div class="col listHeader">
                  <span class="listHeader">10.10am-10.40am</span>
                            ...
                            <div class="col listHeader">
                                <span class="listHeader">No29</span>
                            </div>
                        </div>
                        <div class="d-xl-flex align-items-xl-center row FullListItem" style="
                  border-bottom-width: 2px;
