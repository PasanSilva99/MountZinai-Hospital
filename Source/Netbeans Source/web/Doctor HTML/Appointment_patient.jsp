<%-- Document : Appointment_patient Created on : April 10, 2021, 9:13:22 AM
Author : Sandhara --%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Appointment_patient_List</title>
    ...
    <body>
        ...
        <section class="pagecont">
            <div class="fillPage">
                ...
                <div id="page">
                    <!-- Start: NewList -->
                    <div class="container mt-5" style="display: block; height: 100%">
                        <span style="color: var(--gray)">Appointment List</span>
                        <div class="container" style="height: 90%; overflow: scroll; margin-top: 10px">
                            ...
                            <div class="
                                ...
                                <div class="col listHeader">
                                    <span class="listHeader">No 30</span>
                                </div>
                            </div>
