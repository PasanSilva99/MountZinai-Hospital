                            ...
                            <div style="display: block;height: 100%;">
                                <div class="row">
                                    <div class="col-9 ongoing-number-bg hoverWhite">
                                        <div></div><span class="ongoing-number-text" style="font-size: 36px;color: rgb(255,255,255);">Ongoing Number<span class="WidgetTitleSmall" style="font-size: 83px;color: rgb(255,255,255);">05</span></span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-9 my-number hoverWhite">
                                        <div></div><span class="my-number-text" style="font-size: 36px;color: rgb(255,255,255);">My Number<span class="WidgetTitleSmall" style="font-size: 83px;">25</span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5">
                            <div class="recent-appointment-bg recent-appointment-pos" style="height: 87%;position: absolute;width: 127%;margin: 5px;position: relative;left: -11vw;top: 8vh;"><span class="text-left WidgetTitleSmall" style="margin-left: 25px;font-size: 21px;">Recent Appointments</span>
