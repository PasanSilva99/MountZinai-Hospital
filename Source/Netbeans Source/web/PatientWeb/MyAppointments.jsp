...
<body>
    ...
    <section class="pagecont">
        <div class="fillPage">
            <div id="sideNav">
                <div class="navItem">
                    <div class="NavItemBg-nonActive" style="position: absolute;width: 100%;height: 100%;"></div><img class="NavItemImage" style="width: 35px;height: 35px;margin-left: 28%;margin-right: auto;position: relative;filter: invert(0%);" src="assets/img/dashboard.svg"><span class="NavItemText" style="width: 100%;text-align: center;display: block;position: relative;filter: invert(0%);color: rgb(0,0,0);">Dashboard</span>
                </div>
                <div class="navItem">
                    <div class="NavItemBg" style="position: absolute;width: 100%;height: 100%;"></div><img class="NavItemImage" style="width: 35px;height: 35px;margin-left: 30%;margin-right: auto;position: relative;margin-top: 12%;filter: invert(100%);" src="assets/img/calendar.svg"><span class="NavItemText" style="width: 100%;text-align: center;display: block;position: relative;filter: invert(0%);color: rgb(255,255,255);">My<br>Appointments</span>
                </div>
                <div class="navItem">
            ...
            <div id="page">
                ...
                <div class="container" style="display: block;height: 100%;">
                    <!-- Start: Session List -->
                    <div class="col WidgetGray" style="display: block;height: 488px;width: 100%;position: relative;top: 9vh;left: -2vw;"><span class="text-left WidgetTitleSmall" style="font-size: 24px;">Session List</span><!-- Start: Table Headings -->
                        <div class="table-headings">
                            <!-- Start: Patient Name Wrap -->
                            <div class="patient-name"></div><!-- End: Patient Name Wrap -->
                            ...
                            <div class="date-time"><span class="text-left WidgetTitleSmall" style="font-size: 19px;">Session Date</span></div><!-- End: Date&Time Wrap -->
                            <!-- Start: Appointment No Wrap -->
                            <div class="appointment-no"><span class="text-left WidgetTitleSmall" style="font-size: 19px;">Session Time</span></div><!-- End: Appointment No Wrap -->
                            <!-- Start: Room No Wrap -->
                            <div class="room-no"><span class="text-left WidgetTitleSmall" style="font-size: 19px;">Specialization</span></div><!-- End: Room No Wrap -->
                                        ...
                                        <tr>
                                            ...
                                            <td class="listItem">
                                                <div class="d-flex flex-row listItemBg" style="width: 100%;height: 6vh;">
                                                    <div class="d-xl-flex align-items-xl-center" style="width: 35px;height: 100%;padding: 5px;"><img class="img-fluid icon-position" src="assets/img/appointment%20-%20patient.svg"></div><!-- Start: d-name-lbl -->
                                                    <div class="d-name-lbl"><span style="font-size: 14px;">Dr. Anura Hewageegana</span></div><!-- End: d-name-lbl -->
                                                    <!-- Start: Session Date -->
                                                    <div class="session-date-list"><span style="font-size: 14px;">01 April 2021</span></div><!-- End: Session Date -->
                                                    <!-- Start: Session Time -->
                                                    <div class="session-time-list"><span style="font-size: 14px;">10.30 - 14.00</span></div><!-- End: Session Time -->
                                                    <!-- Start: Specialization -->
                                                    <div class="specialization-lbl"><span style="font-size: 14px;">Cardiologist</span></div><!-- End: Specialization -->
                                                </div>
                                            </td><!-- End: row1 -->
                                            <!-- Start: row1 -->
                                            <td class="listItem">
                        ...
                        <div class="d-xl-flex justify-content-xl-center align-items-xl-center showAll-session"><span>Show All</span></div>
