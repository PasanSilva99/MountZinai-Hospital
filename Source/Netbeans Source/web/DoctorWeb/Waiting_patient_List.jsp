 ...
 Sandhara
      --%>
        ...
        <head>
            ...
            <title>Recent_Patient_List</title>
    ...
    <section class="pagecont">
        <div class="fillPage">
            <div id="sideNav">
                ...
                <div class="navItem">
                    <div class="NavItemBg-nonActive"
                         style="position: absolute;
                         width: 100%;
                             height: 100%;">
                             
                    </div>
                    <img class="NavItemImage-nonActive"
                         style="width: 35px;
                         height: 35px;
                         margin-left: 30%;
                         margin-right: auto;
                    ...
                    <span class="NavItemText-nonActive" 
                          style="width: 100%;
                          text-align: center;
                          display: block;
                          position: relative;">
            ...
            <div id="page">
                ...
                <!-- Start: NewList -->
                <div class="container mt-5" style="display: block;height: 100%;"><span style="color: var(--gray);">Waiting Patient List</span>
                    ...
                    <div               <di               <div class="col listHeader"><span class=">listHeader">10.10am-10.40am</span></div>
                                                 </div>
                        <div class="d-xl-flex align-items-xl-center row FullListItem" style="border-bottom-width: 2px;border-bottom-color: var(--secondary);padding-bottom: 10px;padding-top: 10px;color: var(--gray);margin-top: 10px;">
                            <div class="col-3"><img style="width: 30px;height: 30px;margin-right: 5px;margin-top: -5px;" src="assets/img/profile.svg"><span class="listHeader" style="margin-left: 5PX;">L. G. N. N. Kumarasiri</span></div>
                            <div class="col listHeader"><span class="listHeader">10.10am-10.40am</span></div>
                 ...
                 >           <div class="col listHeader"><span class="listHeader">No 30</span></div>
                         ...
                         /   >      <div class="d-xl-flex align-items-xl-center row FullListItem" style="border-bottom-width: 2px;border-bottom-color: var(--secondary);padding-bottom: 10px;padding-top: 10px;color: var(--gray);margin-top: 10px;">
                        <div             <div class="col-3"><img style="width: 30px;height: 30px;margin-right: 5px;margin-top: -5px;" src="assets/img/profile.svg"><span class="listHeader" style="margin-left: 5PX;">L. G. N. N. Kumarasiri</span></div>
                            <div class="col listHeader"><span class="listHeader">10.10am-10.40am</span></div>
                            <div class="col-3 listHeader"><span class="listHeader">nuwandharanilu@gmail.com</span></div>
                            <div class="col listHeader"><span class="listHeader">076 568 5330</span></div>
                            <div class="col listHeader"><span class="listHeader">No 30</span></div>
  ...
  <script sr    <script src="assets/bootstrap/js/bootstrap.min.js"></script>
                 <<imgt>
        var interval = setInterval(UpdateTime, 1000);
        
        function UpdateTime()
        {
            var dateO = ConvDay(dateObj.getDay());dte = FixLength(dateObj.getDate()); = FixLength(dateObj.getHours());
            ...
            document.getElementById("lbl_day").innerHTML = day;
             ...
             docu           ment.getElementById("lbl_dateSuffix").innerHTML = dateSuffix;
                   docume       nt.getElementById("lbl_timeHour").innerHTML = hour;
                       docu ment.getElementById("lbl_timeMinute").innerHTML = minute;
                }    
...
</html>                                                                                                                            />         <div><img                                                                                                                            />        <div ><img                                                                                                                            />        <div ><img                                                                                                                            />        <div ><img                                                                                                                            />        <div ><img                                                                                                                            />        <div ><img                                                                                                                            />         <div><img                                                                                                                            />        <div ><img                                                                                                                            />         <div><img                                                                                                                            />        <div ><img