<%-- Document : DoctorAppointmentView Created on : April 10, 2021, 10:25:12 AM
Author : pasan --%>
                                ...
                                <div class="row h-75">
                                    <div class="col-6">
                                        <div class="WidgetTotal" style="width: 100%; height: 95%">
                                            <div class="d-xl-flex align-items-xl-center w-100">
                                                <img
                                                    class="img-fluid"
                                            ...
                                            <div class="h-75 row p-0 m-0">
                                                <div class="col-5">
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col mt-3">
                                                            <span class="mt-3 text-white">Time</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col mt-3">
                                                            <span class="mt-3 text-white">Contact NO.</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col mt-3">
                                                            <span class="mt-3 text-white">Èmail</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col mt-3">
                                                ...
                                                <div class="col">
                                                    <div class="row mt-3">
                                                        <div class="col mt-3">
                                                            <span class="mt-3 text-white">5489632</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col mt-3">
                                                            <span class="mt-3 text-white">10 AM - 10:30 AM</span
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col mt-3">
                                                            <span class="mt-3 text-white">077-1234567</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col mt-3">
                                                            <span class="mt-3 text-white">silva123@gmail.com</span
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col mt-3">
                                                            <span class="text-white">235</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col h-100">
                                        <div class="col WidgetGray w-100" style="height: 95%">
                                            <div class="d-xl-flex align-items-xl-center">
                                                <span class="text-left WidgetTitleSmall">Attachments</span
                                                ><span
                                                    class="
                                                    text-left
                                                    d-xl-flex
                                            ...
                                            <a href="DocAddDocument.jsp" style="text-decoration: none">
                                                <div
                                                    class="
                                                    d-xl-flex
                                    ...
                                    <div class="col w-100">
                                        <div class="WidgetGray w-100 d-block">
                                            ...
                                            <div class="m-3 h-50" style="overflow: scroll">
                                                <p>
                                                    A medical note is an entry into a medical or health
                                                    record made by a&nbsp;physician, nurse, lab
                                                    technician&nbsp;<br />
                                                </p>
                                            </div>


                                            <a href="AddNotes.jsp" style="text-decoration: none;">
                                                <div
                                                    class="
                                                    d-xl-flex
                                                    justify-content-xl-center
                                        ...
                                        <div class="col">
                                            <div style="width: 100%; height: 90%">
                                                <div class="col w-100 WidgetGray" style="height: 95%">
                                                    <div class="d-xl-flex align-items-xl-center">
                                                        <span class="text-left WidgetTitleSmall">Prescriptions</span
                                                        ><span
                                                            class="
                                                            text-left
                                                            d-xl-flex
                                                    ...
                                                    <a href="AddPrescription.jsp" style="text-decoration: none;">
                                                        <div
                                                            class="
                                                            d-xl-flex
                                                            justify-content-xl-center
                                            ...
                                            <a href="Dashboard.jsp" style="text-decoration: none;">
                                                <div class="
                                                     ...
                                                     w-100
                                                     " style="margin: 10px; margin-top: 3vh">
                                                    <button class="btn btn-primary" type="button" style="border-radius: 15px; width: 200px">
                                                        Back
                                                    </button>
                                                </div>
                                            </a>
