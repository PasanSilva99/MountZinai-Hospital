<%-- Document : AddNotes Created on : April 10, 2021, 4:41:45 PM Author :
Sandhara --%>
              ...
              >
                ...
                >
                  <span style="font-size: 25px; font-family: candara"
                    ...
                    <img src="assets/img/Add_Note.svg" style="height: 75px; margin-left: 15px" />
                </div>
                </div>
                </div>
                ...
                ">
                    ...
                    w-100
                  " style="margin-top: 20px; font-size: 18px">Add Your Note Here</span
                >
                <textarea
